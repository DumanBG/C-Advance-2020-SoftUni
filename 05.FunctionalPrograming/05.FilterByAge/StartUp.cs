...
namespace _05.FilterByAge
{
    ...
    class Person    // more difficult than Dictionary :)
    {
    ...
    class StartUp
    {
        static void Main()
        {
            ...
            // older or younger, young adult, too old,
            string filter = Console.ReadLine();
            int filterAge = int.Parse(Console.ReadLine());
            Func<Person, bool> condition = GetAgeCondition(filter, filterAge);

            Action<Person> formatter = GetFormatter(Console.ReadLine()); // name  , age , name age
