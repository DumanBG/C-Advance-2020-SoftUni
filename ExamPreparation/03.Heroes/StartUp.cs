      ...
      public  static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Top STR hero is:{heroStrength.Name} {heroStrength.Item.Strength}str");
            Hero heroAbility = repository.GetHeroWithHighestAbility(); // Hero with name Hero Name
            Console.WriteLine($"Top Ability hero is:{heroAbility.Name} {heroAbility.Item.Ability}ability");
            Hero heroIntelligence = repository.GetHeroWithHighestIntelligence(); // Hero with name Hero
            Console.WriteLine($"Top INT hero is:{heroIntelligence.Name} {heroIntelligence.Item.Intelligence}int");
